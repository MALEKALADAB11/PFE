  ...
  getAdvisors(): Advisor[] {
    return [
      { id: 'kb', name: 'Karim Benali', initials: 'KB', role: 'Smartphones 5G',
        ...
        coachScore: 0.91, clients: 7, coachAdvice: 'On track for target. Push SIM accessories.' },
      { id: 'sm', name: 'Sara Moulai', initials: 'SM', role: 'Fiber · Pro Offers',
        avatarColor: '#00B894', caRealized: 1200, caObjectif: 2000,
        performance: 60, previsionEod: 1750, status: 'ok',
        coachScore: 0.73, clients: 5, coachAdvice: 'Boost Pro offers, traffic peak at 17h.' },
      { id: 'at', name: 'Amine Tazi', initials: 'AT', role: 'Accessories',
        avatarColor: '#F9A825', caRealized: 750, caObjectif: 2000,
        performance: 38, previsionEod: 1100, status: 'urgent',
        coachScore: 0.44, clients: 3, coachAdvice: 'Critical gap. Shift to rain accessories +40%.' },
      { id: 'lk', name: 'Leila Khadri', initials: 'LK', role: 'Retention · CRM',
        avatarColor: '#2D9CDB', caRealized: 450, caObjectif: 2000,
        performance: 23, previsionEod: 720, status: 'attente',
        coachScore: 0.28, clients: 2, coachAdvice: 'Re-engage inactive CRM clients.' },
    ];
  }
  ...
  getCoachingCards(): CoachingCard[] {
    return [
      { id: 'c1', advisorName: 'Sofia L.', advisorInitials: 'SL', avatarColor: '#E74C3C',
        priority: 'HIGH', target: 40, gap: 60, context: 'Rain + conversion 38%',
        advice: 'Shift to accessories + fiber upsell. Pair with senior. ETA stock: 35min',
        time: '14:28', status: 'pending' },
      { id: 'c2', advisorName: 'Aïcha M.', advisorInitials: 'AM', avatarColor: '#00B894',
        priority: 'MED', target: 84, gap: 16, context: 'Peak 17h-19h, iPhone 15=3 left',
  ...
  getInventoryItems(): InventoryItem[] {
    return [
      { id: 'i1', sku: 'IPH16PRO', name: 'iPhone 16 Pro', category: 'Smartphone',
        ...
        recommendationDetail: 'Stockout risk 91% — Concert event +40% traffic expected. Delivery ETA: 48h.',
      ...
      { id: 'i2', sku: 'SAMA55', name: 'Samsung A55', category: 'Smartphone',
        ...
        recommendationDetail: 'Optimal stock. Review in 48h.',
        confidence: 0.95, lastUpdated: '14:32', trend: 'stable' },
      { id: 'i3', sku: 'AIRPDP3', name: 'AirPods Pro 3', category: 'Accessory',
        ...
        recommendationDetail: 'Rain weather impact: +40% accessory demand. Insufficient stock for the 15h-17h peak.',
      ...
      { id: 'i4', sku: 'FIB2GPRO', name: 'Box Fibre 2G Pro', category: 'Internet',
        ...
        recommendationDetail: 'Stock more than sufficient.',
        confidence: 0.97, lastUpdated: '14:32', trend: 'stable' },
      { id: 'i5', sku: 'APLWTCH', name: 'Apple Watch S10', category: 'Accessory',
        stock: 2, stockMin: 5, stockMax: 20, demandForecast24h: 6,
        coverageRatio: 0.33, riskLevel: 'critical', riskScore: 0.88,
        recommendation: 'Redistribution from BTQ-08',
        recommendationDetail: 'BTQ-08 stock: 12 units (overstock). Internal transfer recommended. Delay: 4h.',
      ...
      { id: 'i6', sku: 'ASRPREM', name: 'Assurance Premium', category: 'Service',
        ...
        recommendationDetail: 'Dematerialized product. High margin. Favorable rain context.',
  ...
  getInventoryAlerts(): InventoryAlert[] {
    return [
      { id: 'a1', type: 'rupture', sku: 'IPH16PRO', urgency: 'critical',
        message: 'iPhone 16 Pro — 3 units remaining', action: 'Order 15 units',
        time: '14:32' },
      { id: 'a2', type: 'redistribution', sku: 'APLWTCH', urgency: 'high',
        message: 'Apple Watch S10 — critical stock', action: 'Redistribute from BTQ-08',
        time: '14:15' },
      { id: 'a3', type: 'rupture', sku: 'AIRPDP3', urgency: 'high',
        message: 'AirPods Pro 3 — demand peak expected 15h', action: 'Order 10 units',
        time: '14:10' },
    ];
  }
